#!/bin/bash
#SBATCH --job-name=cs550_A6_q1_p2  # the name of your job
#SBATCH --output=/scratch/mh2752/cs550_a6_q1_p2.out # this is the file your output and errors go to
...
do
    ...
    nvcc -arch=compute_37 -code=sm_37 -lcuda -Xcompiler -fopenmp  question1_p2.cu -o q1p2k80
